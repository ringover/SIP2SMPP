...
main( int argc, char *argv[] )
{
    ...
    b.sequence_number  = 1;
    snprintf((char*)b.system_id, sizeof(b.system_id), "%s", "login");
    snprintf((char*)b.password, sizeof(b.password), "%s", "password");
    snprintf((char*)b.system_type, sizeof(b.system_type), "%s", "WWW");
    b.addr_ton    = 0x34;
    b.addr_ton    = 2;
    b.addr_npi    = 1;
    snprintf((char*)b.address_range, sizeof(b.address_range), "%s", "127.0.0.1");
